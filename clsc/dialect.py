...
Adapted for CLSC v0.6: works standalone on plain text and ChromaDB drawers.
...
class Dialect:
    ...
    Usage:
        ...
        dialect.generate_layer1("zettels/", output="LAYER1.clsc.md")
    """
...
if __name__ == "__main__":
    ...
    if args[0] == "--init":
        ...
        output = os.path.join(zettel_dir, "COMPRESSED_MEMORY.clsc.md")
        ...
        zettel_dir = args[1] if len(args) > 1 else "."
        output = os.path.join(zettel_dir, "LAYER1.clsc.md")
